...
public class ToolRuntimeRepository {
    ...
    /**
     * Inserts a synthetic terminal execution when the ToolBinding is no longer
     * available (registry drift). Placeholder binding columns keep the row
     * schema-compliant while the original tool name remains readable.
     */
    public void insertSyntheticTerminalExecution(
            String executionId,
            String toolCallId,
        ...
        jdbc.sql("""
                ...
                .param("runId", runId)
                .param("roundId", roundId, Types.VARCHAR)
                .param("toolId", toolName)
                .param("toolVersion", "")
                .param("toolName", toolName)
                .param("capabilityPath", "")
                .param("manifestHash", "")
                .param("inputHash", inputHash)
                .param("phase", phase)
                .param("outcomeKind", outcomeKind)
